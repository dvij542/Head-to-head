...
#region Training Modes
        ...
        public bool episode_start = true;
        ...
        **/
        ...
        {
            // if (m_envController.sectionIsStraight(m_SectionIndex)){
            //     AddReward(4.0f*m_envController.PassCheckpointLaneReward / (LaneDifferenceRewardDivider*Time.fixedDeltaTime) - 2.0f*m_envController.PassCheckpointLaneReward);
            // }
            // else {
            //     AddReward(2.0f*m_envController.PassCheckpointLaneReward / (LaneDifferenceRewardDivider*Time.fixedDeltaTime));
            // }
            // AddReward(2.0f*m_envController.PassCheckpointLaneReward / (LaneDifferenceRewardDivider*Time.fixedDeltaTime));
            AddReward((2.0f*m_envController.PassCheckpointLaneReward - 2.0f*m_envController.PassCheckpointLaneReward*(LaneDifferenceRewardDivider/(3.5f*3.5f)))/Time.fixedDeltaTime);
        ...
        **/
        public override void OnActionReceived(ActionBuffers actions)
        {
            ...
            // Debug.Log("Here in the base as well");
